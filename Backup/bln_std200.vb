...
Public Class bln_std200
    ...
    Public Function LlenaDataSet(ByVal sSelect As String, ByVal sNombreTabla As String, ByVal ds As DataSet) As DataSet
        Try
            ...
            If sTipoConexion = SQL_SERVER Then
                Using daSQL = New SqlDataAdapter(sSelect, sConexion)
                    ...
                    End SyncLock
                End Using
            ElseIf sTipoConexion = ORACLE Then
                sConexion = "Provider=MSDAORA.1;User ID=srvadm;password=srv; Data Source=10.0.0.4;Persist Security Info=False"
                Using oleda As OleDbDataAdapter = New OleDbDataAdapter(sSelect, sConexion)
    ...
    Public Function ExecBool(ByVal sEjecucion As String) As Boolean
        ...
        Try
            ...
            If sTipoConexion = SQL_SERVER Then
                ...
                End Using
            ElseIf sTipoConexion = ORACLE Then
                Using OracleConexion As New OracleClient.OracleConnection(sConexion)
                    Using OracleCommand As New OracleClient.OracleCommand(sEjecucion, OracleConexion)
